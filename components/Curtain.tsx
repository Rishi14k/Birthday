...
const DEFAULT_TARGET = new Date(Date.UTC(2026, 9, 23, 0, 0, 0) - (5 * 60 + 30) * 60 * 1000);

type UnitKey = 'days' | 'hours' | 'minutes' | 'seconds';

export default function ShowtimeCountdown({
  tickerText = 'SAVE THE DATE · SEPTEMBER 23 ·',
  marqueeTitle = 'NOW SHOWING',
  marqueeSub = "SOMETHING FOR YOUU ANJALI, Live ON 23th",
  doorsText = 'doors open at midnight, Anjali',
  songSrc,
  songVolume = 0.6,
  redirectTo,
  children,
